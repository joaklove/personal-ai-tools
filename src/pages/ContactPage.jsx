    ...
    <div className="min-h-screen flex flex-col">
      ...
      <header className="pt-24 sm:pt-28 md:pt-32 pb-12 sm:pb-16 md:pb-20 bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 text-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 leading-tight">联系我</h1>
          <p className="text-sm sm:text-base md:text-lg lg:text-xl opacity-90 max-w-2xl sm:max-w-3xl mx-auto">如有任何问题或合作意向，欢迎随时联系</p>
        </div>
      </header>
